...
图~\ref{fig:maximal-prime-ideal-relations}清晰地表示出了极大理想、素理想、整环与域之间的关系。

\begin{figure}[htbp]
  \centering
  \input{figures/chapt12-1-maximal-prime-ideal-relations.tikz}
  \caption{极大理想、素理想、整环与域的关系}
  \label{fig:maximal-prime-ideal-relations}
\end{figure}
