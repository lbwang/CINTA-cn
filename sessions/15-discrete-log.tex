...
\begin{figure}
\begin{center}
\includegraphics[scale=0.38]{figures/clog.jpg} 	
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.38]{figures/DLOG941.jpg} 	
...
\begin{figure}
\begin{center}
\includegraphics[scale=1.45]{figures/bgs.pdf} 	
...
不同群中的离散对数问题的难度并不相同。首先，
需要避免一种误解，并非所有群的 DLP 都是难题。比如，如果求加法群$\Z_p$的离散对数问题，即给定$y \equiv x g \pmod{p}$求$x$，其中$y, g \in \Z_p$。
