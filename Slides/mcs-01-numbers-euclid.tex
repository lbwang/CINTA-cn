...
\title{ Mathematical Foundations in Information Security -- 1} 
\author{王立斌} 
...
%%%%%%%%%%%%%%%%%%%%% chapter.tex %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Chapter 1. Number Systems and Euclid Algorithm.
%
%%%%%%%%%%%%%%%%%%%%%%%%
\section{Introduction.}

\frame{\frametitle{本课程的历史.}

\begin{itemize}
\item 2016级之前，结合《计算机安全学》进行数学教学；

\item 2017级--2021级，《信息时代的计算机数学》；

\item 2022级至今，《信息安全的数学基础》（网工、必修）和《计算机科学中的数学》（计科，选修）；
\end{itemize}
}
...
从2023年起，本课程被命名为《信息安全的数学基础》，以下专题为主线:
\begin{itemize}
\item Number Theory -- 初等数论
...
强调，我们关注编程与算法，即所谓的"computational(计算性)"，且以上专题是柔和在一起的内容。本质上这是一门开阔视野、训练思维的课程。
\end{alertblock}
...
\item 公钥密码算法：Diffie-Hellman、RSA、ECC等
